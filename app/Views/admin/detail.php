        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><?= esc($pendaftaran['tanggal_pengajuan']); ?></td>
                </tr>
                <tr>
                    <th>Lama Magang</th>
                ...
                <tr>
                    ...
                    <td><a href="<?= base_url('uploads/surat/' . $pendaftaran['surat_permohonan']); ?>" target="_blank">Lihat Surat</a></td>
                </tr>
            </table>
