...
<?php endif; ?>
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Kelola Instansi</h1>
            ...
            <div class="table-responsive">
                ...
                <div class="modal fade" id="modalTambahInstansi" tabindex="-1" role="dialog" aria-labelledby="modalTambahInstansiLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <form action="<?= base_url('instansi/save') ?>" method="post">
                            <div class="modal-content">
                                <div class="modal-header bg-primary text-white">
                                    <h5 class="modal-title" id="modalTambahInstansiLabel">Tambah Instansi</h5>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label for="tingkat">Tingkat Instansi</label>
                                        <select name="tingkat" id="tingkat" class="form-control" required>
                                            <option value="" hidden selected>Pilih Tingkat Instansi</option>
                        ...
                        <?php if (!empty($instansi) && is_array($instansi)) : ?>
                            <?php $no = 1; foreach ($instansi as $data) : ?>
                                ...
                                <div class="modal fade" id="editModal<?= $data['instansi_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel<?= $data['instansi_id']; ?>" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form action="<?= base_url('instansi/update/' . $data['instansi_id']); ?>" method="post">
                                            <div class="modal-content">
                                                <div class="modal-header bg-warning text-white">
                                                    <h5 class="modal-title" id="editModalLabel<?= $data['instansi_id']; ?>">Edit Instansi</h5>
                                                    <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="tingkat" id="tingkat_<?= $data['instansi_id']; ?>" class="form-control" required>
                                                            <option value="" disabled <?= empty($data['tingkat']) ? 'selected' : ''; ?>>Pilih Tingkat Instansi</option>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="nama_instansi_<?= $data['instansi_id']; ?>">Nama Instansi</label>
